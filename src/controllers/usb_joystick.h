...
// Byte layout of this joystick's HID report, check it with the "Joystick raw" debug
...
// Holds the latest decoded joystick values
...
// Gets HID reports from the library and remembers when the last one came in
class JoystickReportParser : public HIDReportParser {
  ...
  public:
    ...
    bool Has_Valid_Data();
    unsigned long Get_Report_Count();
};
